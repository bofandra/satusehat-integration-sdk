...
func (c Config) Validate() error {
	...
	if c.RateLimitRPM <= 0 || c.MaxRetries <= 0 {
		return fmt.Errorf("rate limit and max retries must be > 0")
	}
	return nil
}
