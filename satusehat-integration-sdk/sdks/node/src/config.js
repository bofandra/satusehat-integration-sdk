...
export class SatusehatConfig {
  constructor(o={}) {
    ...
    this.maxRetries=Number(o.maxRetries ?? 5); this.initialBackoffMs=Number(o.initialBackoffMs ?? 1000); this.maxBackoffMs=Number(o.maxBackoffMs ?? 60000);
